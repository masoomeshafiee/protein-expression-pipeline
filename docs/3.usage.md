...
##### `**Optional step**:``
- Calculate the single mNG intensity if required based on the Nup54-mNG image data.
- If decided to follow this step, please update the config file (see the config.md for more information). If not, you can use the provided number in the config file.
